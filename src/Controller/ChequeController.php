...
class ChequeController extends AbstractController
{
    ...
    /**
     * @Route("/export", name="cheque_export", methods={"GET"})
     */
    public function export(ChequeRepository $chequeRepository): Response
    {
        $dom = new Dompdf();
        ...
        $html = $this->renderView('cheque/liste_cheque.html.twig', [
            'cheques' => $chequeRepository->findAll(),
        ]);
        $dom->loadHtml($html);
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $entityManager->flush();
            $this->addFlash("success", "Votre ajout a été efectué avec success");
    ...
    public function edit(Request $request, Cheque $cheque): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash("success", "Votre edition s'est efectué avec success");
            return $this->redirectToRoute('cheque_index');
        }
